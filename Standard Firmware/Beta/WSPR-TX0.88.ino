...
const uint8_t  SoftwareRevision = 88; //0 to 255
...
*/
    ...
    {
      FactoryData.HW_Revision = 4; // Hardware revision
    ...
    if (InputCMD[1] == 'F') {
      ...
      if ((InputCMD[2] == 'L') && (InputCMD[3] == 'P')) {
        ...
        else //Get Option
        {
          ...
          if ((FactoryData.HW_Version == 1) & (FactoryData.HW_Revision > 9) || (Product_Model == 1028) || Product_Model == 1029)
          {  
