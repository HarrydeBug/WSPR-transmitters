...
const uint8_t  SoftwareRevision = 83; //0 to 255
...
void setup()
{
 ...
 //Read all the Factory data from EEPROM at position 400
  ...
  else  //No factory data was found in EEPROM, set some defaults
  {
    ...
    {
      FactoryData.LP_A_BandNum = 7; //Low Pass filter A is 160m
      FactoryData.LP_B_BandNum = 10; //Low Pass filter B is 80m
      FactoryData.LP_C_BandNum = 11; //Low Pass filter C is 40m
      FactoryData.LP_D_BandNum = 99; //Low Pass filter D is 20m
    }
